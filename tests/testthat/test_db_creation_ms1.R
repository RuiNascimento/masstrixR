...
test_that("database is created correctly and data can be search", {
  ...
  # test if database name is returned correct
  expect_equal(dbFileName, "test.sqlite")

  # create data frame for search
